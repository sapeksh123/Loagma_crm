        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Integrated solution bridging customer relationship workflows with
              financial accounting operations. Manage leads, clients,
              quotations, invoices, and service operations in real-time.
            </p>
          </div>
          ...
          <div className="hidden md:block space-y-3 pt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { title: "Lead Management", desc: "Track & convert leads" },
                { title: "Invoicing", desc: "Automated billing" },
                { title: "Service Tickets", desc: "Real-time tracking" },
